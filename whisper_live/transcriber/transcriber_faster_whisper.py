...
class BatchedInferencePipeline:
    ...
    def transcribe(
        ...
        temperature: Union[float, List[float], Tuple[float, ...]] = 0.0,  # Changed to deterministic for less hallucination,
        compression_ratio_threshold: Optional[float] = 2.4,
        log_prob_threshold: Optional[float] = -1.0,
        no_speech_threshold: Optional[float] = 0.8,  # Increased from 0.6 to reduce hallucinations,
